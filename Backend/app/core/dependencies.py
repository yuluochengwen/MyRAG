...
def get_embedding_service() -> EmbeddingService:
    ...
    from app.services.embedding.embedding_service import get_embedding_service as _get_singleton
    return _get_singleton()


def get_vector_service() -> VectorStoreService:
    """获取向量存储服务（返回全局单例）"""
    from app.services.retrieval.vector_store_service import get_vector_store_service as _get_singleton
    return _get_singleton()
